...
const VideoCard = ({video: {title, thumbnail,video,
  ...
  return (
    <View  className="flex-col items-center px-4 mb-14s">
    <View className="flex-row gap-3 items-start">
        ...
        {play ?(
            ...
            className="w-full h-60 rounded-xl mt-3 relative justify-center items-centers">
                <Image 
                ...
                <Image 
                    source={icons.play}
                    className="w-12 h-12 ml-40 absolute"
                    resizeMode='contain'
                />
            </TouchableOpacity>
        )}
